...
```
    SIGNATURE = {
      ...
      "type_vectors_needed": [
            {"name":"Industrial emissions", "type": "industrial_database_emissions", "description": "You can choose the layer of type 'industrial_database_emissions'."}
        ],
...
- **type_layer_needed**: 
    - name : The name is shown above the the input field in the frontend
    - type : Each layer has a type necessary to the CM. It is particularly needed in order to handle the  <code><ins>**[symbology](#symbology )**</ins></code>of the layer. the different types are :
       ...
       * *building_volumes*,
       * *solar_optimal_total*
   - description : The description is displayed in the frontend as a tooltip. It should help the user to choose a layer 
